...
| `LogPath` | string (path) | `"log"` | — | Base directory for all log files (`error.log`, `debug.log`, `restart.log`, `resolve.log` in the legacy app — see FR-14 and its rewrite note). | FR-14 |
