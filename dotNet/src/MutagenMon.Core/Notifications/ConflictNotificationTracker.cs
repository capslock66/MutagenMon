...
/// <summary>
/// Ports mutagenmonlib/wx/icon.py: TaskBarIcon.notify_conflicts() (FR-11.1)
/// — tracks which "session:file" conflict keys have already been notified
...
/// Ready — mirroring the legacy's <c>had_conflicts</c> update rule exactly,
/// so a transient conflict-free poll mid-sync doesn't cause the same
