...
/// <summary>
/// Ports mutagenmonlib/remote/resolve.py: resolve_all()'s batch-assembly and
...
public static class ConflictBatchPlanner
{
    ...
    /// <summary>Ports resolve_single()'s default-selection rule: prefer
    /// whichever side has the more recent modification time, defaulting to
    /// "B wins" on a tie (matches the legacy's <c>if ftime1t &gt; ftime2t</c>
    /// else-branch, FR-9.3).</summary>
