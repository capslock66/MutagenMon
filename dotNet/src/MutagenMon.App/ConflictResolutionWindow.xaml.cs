...
/// <summary>
/// Ports mutagenmonlib/remote/resolve.py: resolve_single()'s
/// wx.SingleChoiceDialog (FR-9.1/FR-9.2/FR-9.3, screen 5 in
/// requirements/04-ui-screens-inventory.md) — one conflict at a time,
...
public partial class ConflictResolutionWindow : Window
{
    ...
    public static ConflictResolutionChoice? Show(
        Window? owner, int count, int total, string fileName,
