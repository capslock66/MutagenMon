...
/// <summary>
/// Ports mutagenmonlib/wx/wx.py: info_message()/imes.Destroy() — a small
/// undecorated, buttonless window (screen 6 in
/// requirements/04-ui-screens-inventory.md) shown for the duration of a
/// remote (SSH) operation and dismissed automatically once it completes
